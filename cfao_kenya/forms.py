...
#                                            Individual KPI
# =============================================================================================================
class submit_kpi_form(forms.ModelForm):
    class Meta:
        model = individual_Kpi
        fields = ['individual_kpi_title', 'individual_kpi_criteria', 'individual_kpi_function', 'individual_kpi_details', 'individual_kpi_target']

    individual_kpi_title = forms.CharField(max_length=50, widget=forms.TextInput(attrs={'class': 'form-control'}), required=True)
    individual_kpi_criteria = forms.CharField(max_length=100, widget=forms.TextInput(attrs={'class': 'form-control'}), required=True)
    individual_kpi_function = forms.ChoiceField(choices=individual_Kpi.function, widget=forms.Select(attrs={'class': 'form-control'}))
    individual_kpi_details = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'style': 'height: 80px'}), required=True)
    individual_kpi_target = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}), required=True)

    def clean(self):
        cleaned_data = super(submit_kpi_form, self).clean()
...
class IndividualKpiResultsForm(forms.ModelForm):
    ...
    individual_kpi_january_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_february_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_march_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_april_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_may_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_june_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_july_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_august_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_september_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_october_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_november_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
    individual_kpi_december_score = forms.FloatField(widget=forms.NumberInput(attrs={'class': 'form-control'}))
...
class submit_bu_kpi_form(forms.ModelForm):
    ...
    bu_kpi_title = forms.CharField(max_length=50, widget=forms.TextInput(attrs={'class': 'form-control'}), required=True)
    bu_kpi_function = forms.ChoiceField(choices=bu_kpi.function, widget=forms.Select(attrs={'class': 'form-control'}))
    bu_kpi_details = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'style': 'height: 80px'}), required=True)
...
class submit_company_kpi_form(forms.ModelForm):
    ...
    company_kpi_title = forms.CharField(max_length=50, widget=forms.TextInput(attrs={'class': 'form-control'}), required=True)
    company_kpi_function = forms.ChoiceField(choices=company_kpi.function, widget=forms.Select(attrs={'class': 'form-control'}))
    company_kpi_details = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'style': 'height: 80px'}), required=True)
...
class submit_Check_In_Form(forms.ModelForm):
    ...
    class Meta:
        model = checkIn
        fields = ['checkIn_performance_area', 'checkIn_progress_discussed', 'checkIn_team_member_actions', 'checkIn_team_leader_support']

    checkIn_performance_area = forms.CharField(widget=forms.Textarea(attrs={'class': 'textarea', 'id': 'pax' }), required=True)
...
class asssessment_s_tl_Form(forms.ModelForm):
    ...
    score_q1 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q1',}), required=False)
    score_q2 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q2',}), required=False)
    score_q3 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q3',}), required=False)
    score_q4 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q4',}), required=False)
    score_q5 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q5',}), required=False)
    score_q6 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q6',}), required=False)
    score_q7 = forms.ChoiceField(choices=done_staff_evaluates_tl.results, widget=forms.RadioSelect(attrs={'class': 'form-check-input score_q7',}), required=False)

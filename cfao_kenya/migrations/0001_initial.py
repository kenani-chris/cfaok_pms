    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_grade', models.CharField(blank=True, choices=[('T4', 'T4'), ('T3', 'T3'), ('T5', 'T5'), ('T2', 'T2'), ('T6', 'T6'), ('T1', 'T1')], help_text='user grade', max_length=5)),
                ('staff_company', models.CharField(blank=True, choices=[('tydia', 'tydia'), ('toyota_kenya', 'toyota_kenya'), ('cfao_kenya', 'cfao_kenya'), ('tamk', 'tamk'), ('cfao_agri', 'cfao_agri')], help_text='user grade', max_length=15)),
                ('staff_branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='belongs_to_branch', to='cfao_kenya.branch')),
                ('staff_bu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='belongs_to_bu', to='cfao_kenya.bu')),
                ('staff_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='belongs_to_dept', to='cfao_kenya.department')),
                ('staff_head_branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='is_head_branch', to='cfao_kenya.branch')),
                ('staff_head_bu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='is_head_bu', to='cfao_kenya.bu')),
                ('staff_head_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='is_head_dept', to='cfao_kenya.department')),
                ('staff_head_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='is_head_team', to='cfao_kenya.team')),
                ('staff_person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='staff_person', to=settings.AUTH_USER_MODEL)),
                ('staff_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='belongs_to_team', to='cfao_kenya.team')),
            ],
        ),
        migrations.CreateModel(
            name='score_matrix',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='responded_staff', to=settings.AUTH_USER_MODEL)),
                ('response_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='responding_team_leader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='responding_staff', to=settings.AUTH_USER_MODEL)),
                ('response_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='responded_team_leader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='notification',
            fields=[
                ...
                ('notification_receiver', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='notification_receiver', to=settings.AUTH_USER_MODEL)),
                ('notification_sender', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='notification_Sender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='individual_Kpi',
            fields=[
                ...
                ('individual_kpi_bu_leader_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='bu_leader_approval', to=settings.AUTH_USER_MODEL)),
                ('individual_kpi_pms', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_kenya.pms')),
                ('individual_kpi_team_leader_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='team_leader_approval', to=settings.AUTH_USER_MODEL)),
                ('individual_kpi_user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='user_submitting', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('done_q1', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q1', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_q2', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q2', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_q3', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q3', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_q4', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q4', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_q5', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q5', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_q6', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q6', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_q7', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q7', to='cfao_kenya.question_tl_evaluate_staff')),
                ('done_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='staff_evaluated', to=settings.AUTH_USER_MODEL)),
                ('done_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tl_evaluating', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score_q7_comment', models.TextField(blank=True, default=None, null=True)),
                ('done_evaluation', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_kenya.evaluation')),
                ('done_q1', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q1', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_q2', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q2', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_q3', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q3', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_q4', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q4', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_q5', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q5', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_q6', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q6', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_q7', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='q7', to='cfao_kenya.question_staff_evaluate_tl')),
                ('done_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='staff_evaluating', to=settings.AUTH_USER_MODEL)),
                ('done_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='tl_evaluated', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='company_kpi',
            fields=[
                ...
                ('company_kpi_pms_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_kenya.pms')),
                ('company_kpi_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='person_submitting', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='checkIn',
            fields=[
                ...
                ('checkIn_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='individual_user', to=settings.AUTH_USER_MODEL)),
                ('checkIn_team_leader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='team_leader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='bu_kpi',
            fields=[
                ...
                ('bu_kpi_bu', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='Bu_identity', to='cfao_kenya.bu')),
                ('bu_kpi_bu_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='Bu_submitting', to=settings.AUTH_USER_MODEL)),
                ('bu_kpi_pms_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_kenya.pms')),
                ('bu_kpi_team_leader_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='bu_team_leader_approval', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]

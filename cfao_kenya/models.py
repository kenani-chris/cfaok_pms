...
class done_staff_evaluates_tl(models.Model):
    ...
    done_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_kenya_staff_evaluating")
    done_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_kenya_tl_evaluated")
...
class done_tl_evaluates_staff(models.Model):
    done_id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text="Unique identifier done evaluation")
    done_evaluation = models.ForeignKey('evaluation', on_delete=models.RESTRICT)
    done_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_kenya_tl_evaluating")
    done_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_kenya_staff_evaluated")
...
class individual_Kpi(models.Model):
    ...
    individual_kpi_user = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_kenya_user_submitting")

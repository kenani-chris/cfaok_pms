...
class staff(models.Model):
    ...
    staff_bu = models.ForeignKey('bu', on_delete=models.RESTRICT, null=True, blank=True,
                                 related_name="tamk_belongs_to_bu")
...
class checkIn(models.Model):
    ...
    checkIn_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="tamk_team_leader",
...
class done_staff_evaluates_tl(models.Model):
    ...
    done_q1 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q1",
                                blank=True,
                                default=None, null=True)
    done_q2 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q2",
                                blank=True,
                                default=None, null=True)
    done_q3 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q3",
                                blank=True,
                                default=None, null=True)
    done_q4 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q4",
                                blank=True,
                                default=None, null=True)
    done_q5 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q5",
                                blank=True,
                                default=None, null=True)
    done_q6 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q6",
                                blank=True,
                                default=None, null=True)
    done_q7 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="tamk_q7",
                                blank=True,
                                default=None, null=True)
...
class done_tl_evaluates_staff(models.Model):
    ...
    done_q1 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q1",
                                blank=True,
                                default=None, null=True)
    done_q2 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q2",
                                blank=True,
                                default=None, null=True)
    done_q3 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q3",
                                blank=True,
                                default=None, null=True)
    done_q4 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q4",
                                blank=True,
                                default=None, null=True)
    done_q5 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q5",
                                blank=True,
                                default=None, null=True)
    done_q6 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q6",
                                blank=True,
                                default=None, null=True)
    done_q7 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="tamk_q7",
                                blank=True,
                                default=None, null=True)
...
class responses_staff_evaluate_tl(models.Model):
    ...
    response_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT,
                                             related_name="tamk_responded_team_leader")
...
class responses_tl_evaluate_staff(models.Model):
    ...
    response_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT,
                                             related_name="tamk_responding_team_leader")
...
class individual_Kpi(models.Model):
    ...
    individual_kpi_team_leader_approval = models.ForeignKey(User, on_delete=models.RESTRICT,
                                                            related_name="tamk_team_leader_approval", null=True,
                                                            blank=True)
    individual_kpi_bu_leader_approval = models.ForeignKey(User, on_delete=models.RESTRICT,
                                                          related_name="tamk_bu_leader_approval", null=True,
                                                          blank=True)
    # end approvals
    ...
    individual_kpi_target = models.FloatField(null=True)
...
class bu_kpi(models.Model):
    ...
    bu_kpi_team_leader_approval = models.ForeignKey(User, on_delete=models.RESTRICT,
                                                    related_name="tamk_bu_team_leader_approval", null=True,
                                                    blank=True)
    # end approvals
...
class notification(models.Model):
    ...
    notification_sender = models.ForeignKey(User, on_delete=models.RESTRICT,
                                            related_name="tamk_notification_Sender")
    notification_receiver = models.ForeignKey(User, on_delete=models.RESTRICT,
                                              related_name="tamk_notification_receiver")

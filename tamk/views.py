...
class NoActivePmsView(TemplateView):
    template_name = 'tamk/no_active_pms.html'
...
class IndividualKpiView(ListView):
    ...
    template_name = 'tamk/Individual_Kpi/mykpi.html'
...
class SubmitKpiView(CreateView):
    ...
    template_name = 'tamk/Individual_Kpi/submitkpi.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Individual_Kpi_Submit'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Individual_Kpi_Submit'))
...
class TrackKpiView(ListView):
    model = individual_Kpi
    template_name = 'tamk/Individual_Kpi/trackkpi.html'
    active_pms = pms
...
class EditKpiView(UpdateView):
    model = individual_Kpi
    form_class = SubmitKpiForm
    template_name = 'tamk/Individual_Kpi/one_individual_kpi_edit.html'
    active_pms = pms
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:kpi-detail', kwargs={"pk": self.kwargs["pk"]}))
...
class DetailKpiView(DetailView):
    model = individual_Kpi
    template_name = 'tamk/Individual_Kpi/one_individual_kpi.html'
    active_pms = pms
...
class KpiResultView(ListView):
    model = individual_Kpi
    template_name = 'tamk/Individual_Kpi/kpiresults.html'
    active_pms = pms
...
class KpiResultUpdateView(UpdateView):
    ...
    template_name = 'tamk/Individual_Kpi/one_individual_kpi_update.html'
    active_pms = pms
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Individual_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Individual_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))
...
class StaffKpiListView(ListView):
    model = individual_Kpi
    template_name = 'tamk/Staff_Kpi/staffkpi.html'
...
class StaffKpiPendingListView(ListView):
    model = individual_Kpi
    template_name = 'tamk/Staff_Kpi/approvekpi.html'
            ...
            if bu_head is not None:
                ...
                for member in bu_members:
                    if member.staff_head_bu is not None:
                        ...
                        approved1_kpi = kpi.filter(bu_kpi_status='Approved 1')
                        approved2_kpi = kpi.filter(bu_kpi_status='Approved')
                        pending_kpi = kpi.filter(bu_kpi_status='Approved 1')
                        edit_kpi = kpi.filter(bu_kpi_status='Edit')
                        rejected1_kpi = kpi.filter(bu_kpi_status='Rejected')
                        rejected2_kpi = kpi.filter(bu_kpi_status='Rejected 2')
                    else:
                    ...
                    if pending_count > 0 or  approved1_kpi.count() > 0:
...
class StaffKpiApproveView(DetailView):
    model = User
    template_name = 'tamk/Staff_Kpi/one_individual_approve_kpi.html'
    active_pms = pms
    ...
    def get_context_data(self, **kwargs):
        ...
        if pms.objects.filter(pms_status='Active').count() != 1:
            ...
            if context['user_is_bu_head'] is not None:
                context['pending_kpi'] = kpi.filter(individual_kpi_status='Approved 1')
                print( context['pending_kpi'])
            else:
                context['pending_kpi'] = kpi.filter(individual_kpi_status='Pending')
            context['edit_kpi'] = kpi.filter(individual_kpi_status='Edit')
            context['rejected1_kpi'] = kpi.filter(individual_kpi_status='Rejected 1')
...
class StaffTrackKpiOneListViewBUMembers(ListView):
    model = individual_Kpi
    template_name = 'tamk/Staff_Kpi/trackkpi_staff_bu_members.html'
...
class StaffKpiTrackOneViewBUMembers(UpdateView):
    form_class = IndividualKpiResultsForm
    template_name = 'tamk/Staff_Kpi/trackkpi_staff_one.html'
    active_pms = pms
    context_object_name = 'staff'
    pk_url_kwarg = 'kpi_id'
    model = individual_Kpi
...
def approve_individual_kpi_scoreBU(request, pk, kpi_id, month):
    ...
    return HttpResponseRedirect(reverse("tamk:Staff_Track_Kpi_Staff_One_BU", kwargs={'pk': pk, 'kpi_id': kpi_id}))
...
class StaffTrackKpiOneListViewBU(DetailView):
    model = bu
    template_name = 'tamk/Staff_Kpi/trackkpi_staff_bu.html'
...
class StaffKpiTrackOneViewBU(UpdateView):
    ...
    template_name = 'tamk/Staff_Kpi/trackkpi_staff_one_bu.html'
    active_pms = pms
    context_object_name = 'staff'
    pk_url_kwarg = 'kpi_id'
    model = bu_kpi
...
class StaffTrackKpiListViewCompanyMembers(ListView):
    model = individual_Kpi
    template_name = 'tamk/Staff_Kpi/trackkpi_bumembers.html'
...
def approve_individual_kpi(request, pk, kpi_id):
    ...
    return HttpResponseRedirect(reverse("tamk:Staff_Approve_Kpi_Detail", kwargs={'pk': pk}))
...
class StaffTrackKpiListView(ListView):
    model = individual_Kpi
    template_name = 'tamk/Staff_Kpi/trackkpi.html'
...
class StaffTrackKpiOneListView(ListView):
    model = individual_Kpi
    template_name = 'tamk/Staff_Kpi/trackkpi_staff.html'
...
class StaffKpiTrackOneView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Staff_Track_Kpi_Staff_One', kwargs={"pk": self.kwargs["pk"],
                                                                        "kpi_id": self.kwargs["kpi_id"]}))

    def form_valid(self, form):
        super(StaffKpiTrackOneView, self).form_valid(form)
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tamk:Staff_Track_Kpi_Staff_One', kwargs={"pk": self.kwargs["pk"],
                                                                                 "kpi_id": self.kwargs["kpi_id"]}))
...
class BuKpiDashboard(TemplateView):
    template_name = 'tamk/Bu_Kpi/budashboard.html'
    model = bu_kpi
...
class BuKpi(TemplateView):
    template_name = 'tamk/Bu_Kpi/bukpi.html'
    model = bu_kpi
...
class SubmitBuKpiView(CreateView):
    ...
    template_name = 'tamk/Bu_Kpi/submitkpi.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:BU_Kpi_Submit'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:BU_Kpi_Submit'))


@method_decorator(login_required, name='dispatch')
@method_decorator(user_passes_test(is_member_company), name='dispatch')
class TrackBuKpiView(ListView):
    template_name = 'tamk/Bu_Kpi/trackkpi.html'
...
class TrackBuKpiDetailView(DetailView):
    model = bu_kpi
    template_name = 'tamk/Bu_Kpi/one_individual_kpi.html'
...
class TrackBuKpiEditlView(UpdateView):
    model = bu_kpi
    form_class = SubmitBuKpiForm
    template_name = 'tamk/Bu_Kpi/one_individual_kpi_edit.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:BU_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))

    def form_valid(self, form):
        super(TrackBuKpiEditlView, self).form_valid(form)
        messages.success(self.request, 'BU KPI edited successful')
        return HttpResponseRedirect(reverse('tamk:BU_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))


@method_decorator(login_required, name='dispatch')
@method_decorator(user_passes_test(is_member_company), name='dispatch')
class BuKpiResultListView(ListView):
    template_name = 'tamk/Bu_Kpi/kpiresults.html'
...
class BuKpiResultUpdateView(UpdateView):
    model = bu_kpi
    form_class = BuKpiResultsForm
    template_name = 'tamk/Bu_Kpi/one_individual_kpi_update.html'
    active_pms = pms
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tamk:BU_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tamk:BU_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))
...
class CompanyDashboardKpiDetailView(DetailView):
    model = company_kpi
    template_name = 'tamk/Company_Kpi/company_one_individual_kpi.html'
    pk_url_kwarg = 'pk'
...
class CompanyKpi(TemplateView):
    template_name = 'tamk/Company_Kpi/companykpi.html'
    model = company_kpi
...
class SubmitCompanyKpiView(CreateView):
    ...
    template_name = 'tamk/Company_Kpi/submitkpi.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Company_Kpi_Submit'))

    def form_valid(self, form):
        super(SubmitCompanyKpiView, self).form_valid(form)
        messages.success(self.request, 'BU KPI submit successful')

        return HttpResponseRedirect(reverse('tamk:Company_Kpi_Submit'))


@method_decorator(login_required, name='dispatch')
@method_decorator(user_passes_test(is_member_company), name='dispatch')
class EditCompanyKpiView(ListView):
    template_name = 'tamk/Company_Kpi/trackkpi.html'
...
class EditCompanyKpiUpdateView(UpdateView):
    model = company_kpi
    form_class = SubmitCompanyKpiForm
    template_name = 'tamk/Company_Kpi/one_individual_kpi_edit.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Company_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))

    def form_valid(self, form):
        super(EditCompanyKpiUpdateView, self).form_valid(form)
        messages.success(self.request, 'Company KPI edited successful')
        return HttpResponseRedirect(reverse('tamk:Company_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))


@method_decorator(login_required, name='dispatch')
@method_decorator(user_passes_test(is_member_company), name='dispatch')
class CompanyKpiResultListView(ListView):
    template_name = 'tamk/Company_Kpi/kpiresults.html'
...
class CompanyKpiResultUpdateView(UpdateView):
    ...
    template_name = 'tamk/Company_Kpi/one_individual_kpi_update.html'
    active_pms = pms
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tamk:Company_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Company_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))
...
class BUsKpiTrackOneView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:BUs_Track_Kpi_BUs_One', kwargs={"pk": self.kwargs["pk"],
                                                                    "kpi_id": self.kwargs["kpi_id"]}))

    def form_valid(self, form):
        super(BUsKpiTrackOneView, self).form_valid(form)
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tamk:BUs_Track_Kpi_BUs_One', kwargs={"pk": self.kwargs["pk"],
                                                                             "kpi_id": self.kwargs["kpi_id"]}))
...
class MyCheckIn(TemplateView):
    template_name = 'tamk/Check-In/checkin.html'
...
class SubmitCheckIn(CreateView):
    ...
    template_name = 'tamk/Check-In/submitci.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Check-In_Submit'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Check-In_Submit'))


@method_decorator(login_required, name='dispatch')
@method_decorator(user_passes_test(is_member_company), name='dispatch')
class TrackCheckIn(ListView):
    template_name = 'tamk/Check-In/trackci.html'
...
class DetailCheckIn(DetailView):
    model = checkIn
    template_name = 'tamk/Check-In/one_individual_ci.html'
...
class EditCheckIn(UpdateView):
    form_class = SubmitCheckInForm
    template_name = 'tamk/Check-In/one_individual_ci_edit.html'
    model = checkIn
    context_object_name = 'ci'
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Check-In_Edit_One', kwargs={"pk": self.kwargs["pk"]}))
...
class StaffCheckIn(TemplateView):
    template_name = 'tamk/Staff_Ci/staffci.html'
...
class StaffApproveCheckIn(TemplateView):
    template_name = 'tamk/Staff_Ci/approveci.html'
...
class StaffApproveStaffCheckIn(DetailView):
    context_object_name = 'staff'
    model = User
    template_name = 'tamk/Staff_Ci/staffcistaff.html'
...
class StaffApproveStaffCheckInOne(UpdateView):
    ...
    context_object_name = 'ci'
    model = checkIn
    template_name = 'tamk/Staff_Ci/one_individual_approve_ci.html'
    pk_url_kwarg = 'ci_id'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Staff_Approve_CI'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Staff_Approve_CI'))
...
class StaffTrackCheckIn(TemplateView):
    context_object_name = 'staff'
    model = User
    template_name = 'tamk/Staff_Ci/trackci.html'
...
class StaffTrackCheckInBU(TemplateView):
    context_object_name = 'staff'
    model = User
    template_name = 'tamk/Staff_Ci/bu_trackci.html'
...
class StaffTrackStaffCheckIn(DetailView):
    context_object_name = 'staff'
    model = User
    template_name = 'tamk/Staff_Ci/trackci_staff.html'
...
class StaffTrackStaffCheckInBU(DetailView):
    context_object_name = 'staff'
    model = User
    template_name = 'tamk/Staff_Ci/bu_trackci_staff.html'
...
class StaffTrackStaffDetailCheckIn(DetailView):
    ...
    model = checkIn
    pk_url_kwarg = 'ci_id'
    template_name = 'tamk/Staff_Ci/trackci_staff_one.html'
...
class StaffTrackStaffDetailCheckInBU(DetailView):
    ...
    model = checkIn
    pk_url_kwarg = 'ci_id'
    template_name = 'tamk/Staff_Ci/bu_trackci_staff_one.html'
...
class Assessment(TemplateView):
    template_name = 'tamk/Assessment/assessment.html'
...
class AssessmentView(DetailView):
    ...
    model = evaluation
    template_name = 'tamk/Assessment/assessment_list.html'
...
class AssessmentTlS(DetailView):
    context_object_name = 'evaluation'
    model = evaluation
    template_name = 'tamk/Assessment/assessment_tl_s_view.html'
...
class AssessmentTlSStaff(CreateView):
    ...
    template_name = 'tamk/Assessment/assessment_tl_s.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Assessment_S', kwargs={"as_id": self.kwargs["as_id"]}))

    def form_valid(self, form):
        super(AssessmentTlSStaff, self).form_valid(form)
        messages.success(self.request, 'Evaluated staff success')

        return HttpResponseRedirect(reverse('tamk:Assessment_S', kwargs={"as_id": self.kwargs["as_id"]}))
...
class AssessmentSTlStaff(CreateView):
    ...
    template_name = 'tamk/Assessment/assessment_s_tl.html'
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Assessment_TL_One', kwargs={"as_id": self.kwargs["as_id"], "tl_id": self.kwargs["tl_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(
            reverse('tamk:Assessment_S', kwargs={"as_id": self.kwargs["as_id"], "tl_id": self.kwargs["tl_id"]}))


@method_decorator(login_required, name='dispatch')
@method_decorator(user_passes_test(is_member_company), name='dispatch')
class AssessmentPrevious(TemplateView):
    template_name = 'tamk/Assessment/assessment_previous.html'
...
class AssessmentPreviousView(DetailView):
    context_object_name = 'evaluation'
    model = evaluation
    template_name = 'tamk/Assessment/assessment_previous_list.html'
...
class AssessmentSTlStaffPrevious(TemplateView):
    template_name = 'tamk/Assessment/assessment_s_tl_previous.html'
...
class AssessmentTlSStaffPrevious(DetailView):
    context_object_name = 'evaluation'
    model = evaluation
    template_name = 'tamk/Assessment/assessment_tl_s_view_previous.html'
...
class AssessmentTlSPreviousStaff(TemplateView):
    template_name = 'tamk/Assessment/assessment_tl_s_previous.html'
...
class AdminDashboard(TemplateView):
    template_name = 'tamk/Admin/dashboard.html'
...
class AdminBU(TemplateView):
    template_name = 'tamk/Admin/admin_bu.html'
...
class AdminBUOne(UpdateView):
    template_name = 'tamk/Admin/admin_bu_one.html'
    form_class = BUForm
    model = bu
    pk_url_kwarg = 'bu_id'
...
class AdminBUNew(CreateView):
    template_name = 'tamk/Admin/admin_bu_new.html'
    form_class = BUForm
    model = bu
...
class AdminTeam(TemplateView):
    template_name = 'tamk/Admin/admin_team.html'
...
class AdminTeamOne(UpdateView):
    template_name = 'tamk/Admin/admin_team_one.html'
    form_class = TeamForm
    model = team
    pk_url_kwarg = 't_id'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_Teams'))

    def form_valid(self, form):
        super(AdminTeamOne, self).form_valid(form)
        messages.success(self.request, 'Team Successfully')

        return HttpResponseRedirect(reverse('tamk:Admin_Teams'))
...
class AdminTeamNew(CreateView):
    template_name = 'tamk/Admin/admin_team_new.html'
    form_class = TeamForm
    model = team
...
class AdminUser(TemplateView):
    template_name = 'tamk/Admin/admin_users.html'
...
class AdminUserNew(CreateView):
    ...
    template_name = 'tamk/Admin/admin_users_new.html'
    ...
    if request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect(reverse('tamk:Admin_Users_New_Details', kwargs={'pk': user.id}))
        else:
            form = UserCreationForm()
        context['form'] = form
        return render(request, 'tamk/Admin/admin_users_new.html', context)
...
class AdminUserNewDetails(UpdateView):
    model = UserModel
    form_class = UserForm
    template_name = 'tamk/Admin/admin_users_new_details.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_Users_New_Details_Staff', kwargs={'pk': self.kwargs['pk']}))

    def form_valid(self, form):
        super(AdminUserNewDetails, self).form_valid(form)
        messages.success(self.request, 'User updated Successfully')

        return HttpResponseRedirect(reverse('tamk:Admin_Users_New_Details_Staff', kwargs={'pk': self.kwargs['pk']}))
...
class AdminUserNewDetailsStaff(CreateView):
    ...
    template_name = 'tamk/Admin/admin_users_new_details_staff.html'
    ...
    if request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                update_session_auth_hash(request, user)  # Important!
                messages.success(request, 'Your password was successfully updated!')
                return HttpResponseRedirect(reverse('tamk:Admin_Users_reset_password', kwargs={'pk': user.id}))
        else:
            form = UserForm(User.objects.filter(id=pk).first())
        context['form'] = form
        return render(request, 'tamk/Admin/admin_users_new_details.html', context)
    ...
    if request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                update_session_auth_hash(request, user)  # Important!
                messages.success(request, 'Your password was successfully updated!')
                return HttpResponseRedirect(reverse('tamk:Admin_Users_reset_password', kwargs={'pk': pk}))
        else:
            form = SetPasswordForm(staff_u)
        context['form'] = form
        return render(request, 'tamk/Admin/admin_users_reset_password.html', context)
...
class AdminResetPasswordUser(UpdateView):
    ...
    template_name = 'tamk/Admin/admin_users_reset_password.html'
    pk_url_kwarg = 'pk'
...
class AdminUserOne(DetailView):
    model = User
    context_object_name = 'user'
    template_name = 'tamk/Admin/admin_users_one.html'
...
def reset_user_password(request, pk):
    if request.user.is_superuser:
        return HttpResponseRedirect(reverse('tamk:password_reset_confirm',
...
class AdminUserOneEditUser(UpdateView):
    model = UserModel
    form_class = UserForm
    template_name = 'tamk/Admin/admin_users_one_edit_user.html'
    context_object_name = 'user'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_Users_One', kwargs={'pk': self.kwargs['pk']}))

    def form_valid(self, form):
        super(AdminUserOneEditUser, self).form_valid(form)
        messages.success(self.request, 'User updated Successfully')

        return HttpResponseRedirect(reverse('tamk:Admin_Users_One', kwargs={'pk': self.kwargs['pk']}))
...
class AdminUserOneEditStaff(UpdateView):
    model = staff
    form_class = StaffForm
    template_name = 'tamk/Admin/admin_users_one_edit_staff.html'
    context_object_name = 'staff'
...
class AdminPMS(DetailView):
    model = pms
    template_name = 'tamk/Admin/pms.html'
    pk_url_kwarg = 'pms_id'
...
class AdminPMSEdit(UpdateView):
    model = pms
    form_class = PmsForm
    template_name = 'tamk/Admin/pms_edit.html'
    pk_url_kwarg = 'pms_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS', kwargs={"pms_id": self.kwargs["pms_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSNew(CreateView):
    model = pms
    form_class = PmsForm
    template_name = 'tamk/Admin/pms_new.html'
    pk_url_kwarg = 'pms_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_Dashboard'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_Dashboard'))
...
class AdminPMSStaff(ListView):
    model = staff
    template_name = 'tamk/Admin/pms_staff.html'
...
class AdminPMSStaffOne(DetailView):
    template_name = 'tamk/Admin/pms_staff_one.html'
...
class AdminPMSStaffOneEdit(UpdateView):
    template_name = 'tamk/Admin/pms_staff_edit.html'
    form_class = StaffForm
...
class AdminPMSIndividual(ListView):
    model = staff
    template_name = 'tamk/Admin/pms_ind_kpi.html'
...
class AdminPMSIndividualStaff(ListView):
    model = individual_Kpi
    template_name = 'tamk/Admin/pms_ind_kpi_staff.html'
...
class AdminPMSIndividualStaffOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_ind_kpi_staff_one.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Individual_Staff_One',
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Individual_Staff_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                                    'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSIndividualStaffNew(CreateView):
    model = individual_Kpi
    form_class = IndividualKpiForm
    template_name = 'tamk/Admin/pms_ind_kpi_staff_new.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Individual_Staff',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Individual_Staff',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
...
class AdminPMSBU(ListView):
    model = staff
    template_name = 'tamk/Admin/pms_bu_kpi.html'
...
class AdminPMSBUStaff(ListView):
    model = bu_kpi
    template_name = 'tamk/Admin/pms_bu_kpi_staff.html'
...
class AdminPMSBUStaffOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_bu_kpi_staff_one.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_BU_Staff_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                           'kpi_id': self.kwargs['kpi_id']}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_BU_Staff_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                                    'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSBUStaffNew(CreateView):
    model = bu_kpi
    form_class = BUKpiForm
    template_name = 'tamk/Admin/pms_bu_kpi_staff_new.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Admin_PMS_BU_Staff', kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
...
class AdminPMSCompany(ListView):
    model = company_kpi
    template_name = 'tamk/Admin/pms_company_kpi.html'
...
class AdminPMSCompanyOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_company_kpi_one.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Admin_PMS_Company_One', kwargs={"pms_id": self.kwargs["pms_id"], 'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSCompanyNew(CreateView):
    model = company_kpi
    form_class = CompanyKpiForm
    template_name = 'tamk/Admin/pms_company_kpi_new.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Company', kwargs={"pms_id": self.kwargs["pms_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Company', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSCheckIn(ListView):
    model = staff
    template_name = 'tamk/Admin/pms_checkin.html'
...
class AdminPMSCheckInScoreNew(CreateView):
    ...
    template_name = 'tamk/Admin/pms_checkin_score_new.html'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_CheckIn', kwargs={"pms_id": self.kwargs["pms_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_CheckIn', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSCheckInScoreOne(UpdateView):
    model = matrix_checkin
    form_class = MatrixCheckIn
    template_name = 'tamk/Admin/pms_checkin_score_one.html'
    pk_url_kwarg = 'm_id'
...
class AdminPMSCheckInStaff(ListView):
    model = checkIn
    template_name = 'tamk/Admin/pms_checkin_staff.html'
...
class AdminPMSCheckInStaffOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_checkin_staff_one.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_CheckIn_Staff_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                           'kpi_id': self.kwargs['kpi_id']}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_CheckIn_Staff_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                                    'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSCheckInStaffNew(CreateView):
    model = checkIn
    form_class = CheckInForm
    template_name = 'tamk/Admin/pms_checkin_staff_new.html'
    pk_url_kwarg = 'kpi_id'

    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Admin_PMS_CheckIn_Staff', kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
...
class AdminPMSAssessment(ListView):
    model = evaluation
    template_name = 'tamk/Admin/pms_assessment.html'
    context_object_name = 'evaluation'
...
class AdminPMSAssessmentOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_assessment_one.html'
    context_object_name = 'evaluation'
    pk_url_kwarg = 'as_id'
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Assessment_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id']}))

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Assessment_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id']}))
...
class AdminPMSAssessmentNew(CreateView):
    model = evaluation
    form_class = AssessmentForm
    template_name = 'tamk/Admin/pms_assessment_new.html'
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Assessment', kwargs={"pms_id": self.kwargs["pms_id"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Assessment', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSAssessmentOneResponseNew(CreateView):
    ...
    template_name = 'tamk/Admin/pms_assessment_one_response_new.html'
...
class AdminPMSAssessmentOneResponseOne(UpdateView):
    model = evaluation_responses
    form_class = MatrixAssessment
    template_name = 'tamk/Admin/pms_assessment_one_response_one.html'
    pk_url_kwarg = 'm_id'
...
class AdminPMSAssessmentOneQuestionOneTlS(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_assessment_one_question_one_tl_s.html'
...
class AdminPMSAssessmentOneQuestionOneSTl(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_assessment_one_question_one_s_tl.html'
    context_object_name = 'question'
    pk_url_kwarg = 'q_id'
...
class AdminPMSAssessmentOneQuestionNewSTl(CreateView):
    model = question_staff_evaluate_tl
    form_class = QuestionSTlForm
    template_name = 'tamk/Admin/pms_assessment_one_question_new_s_tl.html'
    context_object_name = 'question'
    pk_url_kwarg = 'q_id'
...
class AdminPMSAssessmentOneResponseSTl(DetailView):
    model = evaluation
    template_name = 'tamk/Admin/pms_assessment_one_stl.html'
    context_object_name = 'evaluation'
    pk_url_kwarg = 'as_id'
...
class AdminPMSAssessmentOneResponseSTlOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_assessment_one_question_one_s_tl_one.html'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Assessment_One_STl_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Assessment_One_STl_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
                                                    'd_id': self.kwargs['d_id'], }))
...
class AdminPMSAssessmentOneResponseTlS(DetailView):
    model = evaluation
    template_name = 'tamk/Admin/pms_assessment_one_tls.html'
    context_object_name = 'evaluation'
    pk_url_kwarg = 'as_id'
...
class AdminPMSAssessmentOneResponseTlSOne(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_assessment_one_question_one_tl_s_one.html'
    context_object_name = 'done'
    pk_url_kwarg = 'd_id'
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tamk:Admin_PMS_Assessment_One_TlS_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
                                           'd_id': self.kwargs['d_id'], }))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tamk:Admin_PMS_Assessment_One_TlS_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
                                                    'd_id': self.kwargs['d_id'], }))
...
class Matrix(TemplateView):
    template_name = 'tamk/Admin/pms_matrix.html'
...
class AdminPMSMatrixScore(UpdateView):
    ...
    template_name = 'tamk/Admin/pms_matrix_score.html'
    pk_url_kwarg = 'm_id'
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Admin_PMS_Matrix_Score', kwargs={"pms_id": self.kwargs["pms_id"], 'm_id': self.kwargs['m_id']}))
...
class AdminPMSMatrixScoreNew(CreateView):
    model = score_matrix
    form_class = MatrixScore
    template_name = 'tamk/Admin/pms_matrix_score_new.html'
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Admin_PMS_Matrix', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSMatrixKPI(TemplateView):
    template_name = 'tamk/Admin/pms_matrix_kpi.html'
...
class AdminPMSMatrixKPINew(CreateView):
    ...
    template_name = 'tamk/Admin/pms_matrix_kpi_new.html'
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tamk:Admin_PMS_Matrix_KPI', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSMatrixKPIOne(UpdateView):
    model = kpi_months
    form_class = MatrixKpi
    template_name = 'tamk/Admin/pms_matrix_kpi_one.html'
    pk_url_kwarg = 'm_id'
...
class AdminPMSMatrixAssessment(TemplateView):
    template_name = 'tamk/Admin/pms_matrix_assessment.html'
...
class Report(TemplateView):
    template_name = 'tamk/Reports/report.html'
...
class ReportKPI(TemplateView):
    template_name = 'tamk/Reports/report_kpi.html'
...
class ReportCheckIn(TemplateView):
    template_name = 'tamk/Reports/report_checkin.html'
...
class ReportAssessment(TemplateView):
    template_name = 'tamk/Reports/report_assessment.html'
...
class ReportAssessmentDetail(TemplateView):
    template_name = 'tamk/Reports/report_assessment_detail.html'
...
class Profile(TemplateView):
    template_name = 'tamk/profile.html'

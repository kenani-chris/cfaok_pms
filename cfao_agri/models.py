...
class staff(models.Model):
    staff_person = models.OneToOneField(User, on_delete=models.CASCADE, related_name="cfao_agri_staff_person")
...
class checkIn(models.Model):
    ...
    checkIn_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_individual_user")
    checkIn_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_team_leader", null=True,
                                            blank=True)
...
class done_staff_evaluates_tl(models.Model):
    ...
    done_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_staff_evaluating")
    done_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_tl_evaluated")
    ...
    done_q1 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q1", blank=True,
                                default=None, null=True)
    done_q2 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q2", blank=True,
                                default=None, null=True)
    done_q3 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q3", blank=True,
                                default=None, null=True)
    done_q4 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q4", blank=True,
                                default=None, null=True)
    done_q5 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q5", blank=True,
                                default=None, null=True)
    done_q6 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q6", blank=True,
                                default=None, null=True)
    done_q7 = models.ForeignKey('question_staff_evaluate_tl', on_delete=models.RESTRICT, related_name="cfao_agri_q7", blank=True,
                                default=None, null=True)
...
class done_tl_evaluates_staff(models.Model):
    done_id = models.UUIDField(primary_key=True, default=uuid.uuid4, help_text="Unique identifier done evaluation")
    done_evaluation = models.ForeignKey('evaluation', on_delete=models.RESTRICT)
    done_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_tl_evaluating")
    done_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_staff_evaluated")
    ...
    done_q1 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q1", blank=True,
                                default=None, null=True)
    done_q2 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q2", blank=True,
                                default=None, null=True)
    done_q3 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q3", blank=True,
                                default=None, null=True)
    done_q4 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q4", blank=True,
                                default=None, null=True)
    done_q5 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q5", blank=True,
                                default=None, null=True)
    done_q6 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q6", blank=True,
                                default=None, null=True)
    done_q7 = models.ForeignKey('question_tl_evaluate_staff', on_delete=models.RESTRICT, related_name="cfao_agri_q7", blank=True,
                                default=None, null=True)
...
class responses_staff_evaluate_tl(models.Model):
    ...
    response_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_responding_staff")
    response_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_responded_team_leader")
...
class responses_tl_evaluate_staff(models.Model):
    ...
    response_team_leader = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_responding_team_leader")
    response_staff = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_responded_staff")
    response_score = models.IntegerField()
    response_comment = models.TextField()
...
class individual_Kpi(models.Model):
    ...
    individual_kpi_user = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_user_submitting")

    # Approvals
    individual_kpi_team_leader_approval = models.ForeignKey(User, on_delete=models.RESTRICT,
                                                            related_name="cfao_agri_team_leader_approval", null=True, blank=True)
    individual_kpi_bu_leader_approval = models.ForeignKey(User, on_delete=models.RESTRICT,
                                                          related_name="cfao_agri_bu_leader_approval", null=True, blank=True)
    # end approvals
...
class bu_kpi(models.Model):
    ...
    bu_kpi_bu = models.ForeignKey('bu', on_delete=models.RESTRICT, related_name="cfao_agri_Bu_identity")
    # Approvals
    bu_kpi_bu_user = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_Bu_submitting", null=True,
                                       blank=True)
    bu_kpi_team_leader_approval = models.ForeignKey(User, on_delete=models.RESTRICT,
                                                    related_name="cfao_agri_bu_team_leader_approval", null=True, blank=True)
    # end approvals
...
class company_kpi(models.Model):
    ...
    company_kpi_user = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_person_submitting", null=True,
                                         blank=True)
...
class notification(models.Model):
    ...
    notification_sender = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_notification_Sender")
    notification_receiver = models.ForeignKey(User, on_delete=models.RESTRICT, related_name="cfao_agri_notification_receiver")

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_evaluation', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.evaluation')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_grade', models.CharField(blank=True, choices=[('T1', 'T1'), ('T3', 'T3'), ('T2', 'T2'), ('T4', 'T4'), ('T6', 'T6'), ('T5', 'T5')], help_text='user grade', max_length=5)),
                ('staff_company', models.CharField(blank=True, choices=[('tamk', 'tamk'), ('cfao_agri', 'cfao_agri'), ('tydia', 'tydia'), ('cfao_kenya', 'cfao_kenya'), ('toyota_kenya', 'toyota_kenya')], help_text='user grade', max_length=15)),
                ('staff_branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_belongs_to_branch', to='cfao_agri.branch')),
                ('staff_bu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_belongs_to_bu', to='cfao_agri.bu')),
                ('staff_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_belongs_to_dept', to='cfao_agri.department')),
                ('staff_head_branch', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_is_head_branch', to='cfao_agri.branch')),
                ('staff_head_bu', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_is_head_bu', to='cfao_agri.bu')),
                ('staff_head_department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_is_head_dept', to='cfao_agri.department')),
                ('staff_head_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_is_head_team', to='cfao_agri.team')),
                ('staff_person', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='cfao_agri_staff_person', to=settings.AUTH_USER_MODEL)),
                ('staff_team', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_belongs_to_team', to='cfao_agri.team')),
            ],
        ),
        migrations.CreateModel(
            name='score_matrix',
            fields=[
                ...
                ('matrix_pms', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.pms')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_question', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.question_tl_evaluate_staff')),
                ('response_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_responded_staff', to=settings.AUTH_USER_MODEL)),
                ('response_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_responding_team_leader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response_score', models.IntegerField()),
                ('response_comment', models.TextField()),
                ('response_question', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.question_staff_evaluate_tl')),
                ('response_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_responding_staff', to=settings.AUTH_USER_MODEL)),
                ('response_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_responded_team_leader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='notification',
            fields=[
                ...
                ('notification_receiver', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_notification_receiver', to=settings.AUTH_USER_MODEL)),
                ('notification_sender', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_notification_Sender', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='individual_Kpi',
            fields=[
                ...
                ('individual_kpi_bu_leader_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_bu_leader_approval', to=settings.AUTH_USER_MODEL)),
                ('individual_kpi_pms', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.pms')),
                ('individual_kpi_team_leader_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_team_leader_approval', to=settings.AUTH_USER_MODEL)),
                ('individual_kpi_user', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_user_submitting', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
            model_name='evaluation',
            name='evaluation_pms',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.pms'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('done_evaluation', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.evaluation')),
                ('done_q1', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q1', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_q2', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q2', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_q3', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q3', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_q4', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q4', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_q5', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q5', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_q6', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q6', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_q7', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q7', to='cfao_agri.question_tl_evaluate_staff')),
                ('done_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_staff_evaluated', to=settings.AUTH_USER_MODEL)),
                ('done_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_tl_evaluating', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score_q7_comment', models.TextField(blank=True, default=None, null=True)),
                ('done_evaluation', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.evaluation')),
                ('done_q1', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q1', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_q2', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q2', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_q3', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q3', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_q4', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q4', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_q5', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q5', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_q6', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q6', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_q7', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_q7', to='cfao_agri.question_staff_evaluate_tl')),
                ('done_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_staff_evaluating', to=settings.AUTH_USER_MODEL)),
                ('done_team_leader', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_tl_evaluated', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='company_kpi',
            fields=[
                ...
                ('company_kpi_pms_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.pms')),
                ('company_kpi_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_person_submitting', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='checkIn',
            fields=[
                ...
                ('checkIn_pms', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.pms')),
                ('checkIn_staff', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_individual_user', to=settings.AUTH_USER_MODEL)),
                ('checkIn_team_leader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_team_leader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='bu_kpi',
            fields=[
                ...
                ('bu_kpi_bu', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_Bu_identity', to='cfao_agri.bu')),
                ('bu_kpi_bu_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_Bu_submitting', to=settings.AUTH_USER_MODEL)),
                ('bu_kpi_pms_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='cfao_agri.pms')),
                ('bu_kpi_team_leader_approval', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='cfao_agri_bu_team_leader_approval', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]

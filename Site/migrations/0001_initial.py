# Generated by Django 4.0.3 on 2022-03-18 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='Site.company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_date_created', models.DateTimeField(null=True)),
                ('staff_category', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.RESTRICT, to='Site.levelcategory')),
                ...
                ('staff_person', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='Staff_person', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matrix_checkin_weight', models.FloatField(blank=True, default=100, null=True)),
                ('matrix_kpi_weight', models.FloatField(blank=True, default=50, null=True)),
                ('matrix_assessment_weight', models.FloatField(blank=True, default=20, null=True)),
                ('matrix_bu_weight', models.FloatField(blank=True, default=20, null=True)),
                ('matrix_company_weight', models.FloatField(blank=True, default=10, null=True)),
                ('matrix_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='Site.levelcategory')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('help_category', models.CharField(choices=[('KPI', 'KPI'), ('Check-In', 'Check-In'), ('Assessment', 'Assessment'), ('Reports', 'Reports'), ('Results', 'Results'), ('Other', 'Other')], default='KPI', max_length=20)),
                ('help_log_date', models.DateTimeField(null=True)),

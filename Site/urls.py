...
urlpatterns = [
    ...
    path('<int:company_id>/CheckIn/Create/Previous',
         MyCheckInPrevious.as_view(template_name='Site/CheckIn/my_CheckIn/previous_list.html'),
         name='My_CheckIn_Create_Previous'),
    path('<int:company_id>/CheckIn/Create/Previous/<slug:month>',
         MyCheckInCreatePrevious.as_view(template_name='Site/CheckIn/my_CheckIn/previous_create.html'),
         name='My_CheckIn_Create_Previous_Month'),
    ...
    path('<int:company_id>/Assessment/View/<int:pk>/Member/<int:uid>/<slug:a_dir>',
         AssessmentViewMember.as_view(template_name='Site/Assessment/view_staff.html'),
         name='Assessment_View_Member'),
    path('<int:company_id>/Assessment/View/<int:aid>/Member/<int:staff_id>/<slug:a_dir>/Question/<int:qid>/Create',
         staff_create_question_response, name='Assessment_Create_Response'),
    path('<int:company_id>/Assessment/View/<int:aid>/Member/<int:staff_id>/<slug:a_dir>/Question/<int:rid>/Edit',
         staff_edit_question_response, name='Assessment_Edit_Response'),
    path('<int:company_id>/Assessment/View/<int:pk>/Member/<int:uid>/<slug:a_dir>/Question/<int:qid>',
         AssessmentViewMemberResponseCreate.as_view(template_name='Site/Assessment/create.html'),
         name='Assessment_View_Member_Response'),
    path('<int:company_id>/Assessment/View/<int:pk>/Member/<int:uid>/<slug:a_dir>/Response/<int:qrid>/Edit',
    ...
    path('<int:company_id>/Assessment/View/<int:pk>/My/<slug:a_dir>',
    ...
    path('<int:company_id>/Report/KPI-Submission-Results', ReportKPISubmissionsResults.as_view(
        template_name='Site/Reports/kpi_submissions_results.html'), name='Report_KPI_Submission_Results'),

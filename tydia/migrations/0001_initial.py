    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('staff_company', models.CharField(blank=True, choices=[('tamk', 'tamk'), ('tydia', 'tydia'), ('toyota_kenya', 'toyota_kenya'), ('cfao_kenya', 'cfao_kenya'), ('cfao_agri', 'cfao_agri')], help_text='user grade', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_kpi_pms_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='tydia.pms')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bu_kpi_bu_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='tydia_Bu_submitting', to=settings.AUTH_USER_MODEL)),
                ('bu_kpi_pms_id', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='tydia.pms')),

...
def reset_all_password(request):
    ...
    for staff_u in staffs:
        ...
        # message = format_html('Click On the following <a href="{}">HERE</a>to reset your PMS password the following', reverse('tydia_url_password_reset_confirm', kwargs={'uidb64': urlsafe_base64_encode(force_bytes(user.id)), 'token': default_token_generator.make_token(user)}))
    ...
    return HttpResponseRedirect(reverse('tydia_url_index'))
...
class SubmitKpiView(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Individual_Kpi_Submit'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Individual_Kpi_Submit'))
...
class EditKpiView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_kpi-detail', kwargs={"pk": self.kwargs["pk"]}))
...
class KpiResultUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Individual_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Individual_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))
...
class StaffKpiTrackOneView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Staff_Track_Kpi_Staff_One', kwargs={"pk": self.kwargs["pk"],
                                                                        "kpi_id": self.kwargs["kpi_id"]}))

    def form_valid(self, form):
        super(StaffKpiTrackOneView, self).form_valid(form)
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tydia_url_Staff_Track_Kpi_Staff_One', kwargs={"pk": self.kwargs["pk"],
                                                                                 "kpi_id": self.kwargs["kpi_id"]}))
...
class SubmitBuKpiView(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_BU_Kpi_Submit'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_BU_Kpi_Submit'))
...
class TrackBuKpiEditlView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_BU_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))

    def form_valid(self, form):
        super(TrackBuKpiEditlView, self).form_valid(form)
        messages.success(self.request, 'BU KPI edited successful')
        return HttpResponseRedirect(reverse('tydia_url_BU_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))
...
class BuKpiResultUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tydia_url_BU_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_BU_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))
...
class SubmitCompanyKpiView(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Company_Kpi_Submit'))

    def form_valid(self, form):
        super(SubmitCompanyKpiView, self).form_valid(form)
        messages.success(self.request, 'BU KPI submit successful')

        return HttpResponseRedirect(reverse('tydia_url_Company_Kpi_Submit'))
...
class EditCompanyKpiUpdateView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Company_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))

    def form_valid(self, form):
        super(EditCompanyKpiUpdateView, self).form_valid(form)
        messages.success(self.request, 'Company KPI edited successful')
        return HttpResponseRedirect(reverse('tydia_url_Company_Kpi_Edit_One', kwargs={"pk": self.kwargs["pk"]}))
...
class CompanyKpiResultUpdateView(UpdateView):
    ...
    def form_valid(self, form):
        ...
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tydia_url_Company_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Company_Kpi_Result_Update', kwargs={"pk": self.kwargs["pk"]}))
...
class BUsKpiTrackOneView(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_BUs_Track_Kpi_BUs_One', kwargs={"pk": self.kwargs["pk"],
                                                                    "kpi_id": self.kwargs["kpi_id"]}))

    def form_valid(self, form):
        super(BUsKpiTrackOneView, self).form_valid(form)
        messages.success(self.request, 'KPI Update successful')
        return HttpResponseRedirect(reverse('tydia_url_BUs_Track_Kpi_BUs_One', kwargs={"pk": self.kwargs["pk"],
                                                                             "kpi_id": self.kwargs["kpi_id"]}))
...
class SubmitCheckIn(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Check-In_Submit'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Check-In_Submit'))
...
class EditCheckIn(UpdateView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Check-In_Edit_One', kwargs={"pk": self.kwargs["pk"]}))
...
class StaffApproveStaffCheckInOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Staff_Approve_CI'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Staff_Approve_CI'))
...
class AssessmentTlSStaff(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Assessment_S', kwargs={"as_id": self.kwargs["as_id"]}))

    def form_valid(self, form):
        super(AssessmentTlSStaff, self).form_valid(form)
        messages.success(self.request, 'Evaluated staff success')

        return HttpResponseRedirect(reverse('tydia_url_Assessment_S', kwargs={"as_id": self.kwargs["as_id"]}))
...
class AssessmentSTlStaff(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Assessment_TL_One', kwargs={"as_id": self.kwargs["as_id"], "tl_id": self.kwargs["tl_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(
            reverse('tydia_url_Assessment_S', kwargs={"as_id": self.kwargs["as_id"], "tl_id": self.kwargs["tl_id"]}))
...
class AdminBUOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_BUs'))

    def form_valid(self, form):
        super(AdminBUOne, self).form_valid(form)
        messages.success(self.request, 'BU updated Successfully')

        return HttpResponseRedirect(reverse('tydia_url_Admin_BUs'))
...
class AdminTeamOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_Teams'))

    def form_valid(self, form):
        super(AdminTeamOne, self).form_valid(form)
        messages.success(self.request, 'Team Successfully')

        return HttpResponseRedirect(reverse('tydia_url_Admin_Teams'))
    ...
    if request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                return HttpResponseRedirect(reverse('tydia_url_Admin_Users_New_Details', kwargs={'pk': user.id}))
        else:
...
class AdminUserNewDetails(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_Users_New_Details_Staff', kwargs={'pk': self.kwargs['pk']}))

    def form_valid(self, form):
        super(AdminUserNewDetails, self).form_valid(form)
        messages.success(self.request, 'User updated Successfully')

        return HttpResponseRedirect(reverse('tydia_url_Admin_Users_New_Details_Staff', kwargs={'pk': self.kwargs['pk']}))
    ...
    if request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                update_session_auth_hash(request, user)  # Important!
                messages.success(request, 'Your password was successfully updated!')
                return HttpResponseRedirect(reverse('tydia_url_Admin_Users_reset_password', kwargs={'pk': user.id}))
        else:
    ...
    if request.user.is_superuser:
        ...
        if request.method == 'POST':
            ...
            if form.is_valid():
                ...
                update_session_auth_hash(request, user)  # Important!
                messages.success(request, 'Your password was successfully updated!')
                return HttpResponseRedirect(reverse('tydia_url_Admin_Users_reset_password', kwargs={'pk': pk}))
        else:
...
def reset_user_password(request, pk):
    if request.user.is_superuser:
        return HttpResponseRedirect(reverse('tydia_url_password_reset_confirm',
...
class AdminUserOneEditUser(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_Users_One', kwargs={'pk': self.kwargs['pk']}))

    def form_valid(self, form):
        super(AdminUserOneEditUser, self).form_valid(form)
        messages.success(self.request, 'User updated Successfully')

        return HttpResponseRedirect(reverse('tydia_url_Admin_Users_One', kwargs={'pk': self.kwargs['pk']}))
...
class AdminPMSEdit(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS', kwargs={"pms_id": self.kwargs["pms_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_Dashboard'))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_Dashboard'))
...
class AdminPMSIndividualStaffOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Individual_Staff_One',
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Individual_Staff_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                                    'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSIndividualStaffNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Individual_Staff',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Individual_Staff',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
...
class AdminPMSBUStaffOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_BU_Staff_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                           'kpi_id': self.kwargs['kpi_id']}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_BU_Staff_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                                    'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSBUStaffNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Admin_PMS_BU_Staff', kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
...
class AdminPMSCompanyOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Admin_PMS_Company_One', kwargs={"pms_id": self.kwargs["pms_id"], 'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSCompanyNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Company', kwargs={"pms_id": self.kwargs["pms_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Company', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSCheckInScoreNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_CheckIn', kwargs={"pms_id": self.kwargs["pms_id"]}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_CheckIn', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSCheckInStaffOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_CheckIn_Staff_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                           'kpi_id': self.kwargs['kpi_id']}))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_CheckIn_Staff_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id'],
                                                    'kpi_id': self.kwargs['kpi_id']}))
...
class AdminPMSCheckInStaffNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Admin_PMS_CheckIn_Staff', kwargs={"pms_id": self.kwargs["pms_id"], 's_id': self.kwargs['s_id']}))
...
class AdminPMSAssessmentOne(UpdateView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Assessment_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id']}))

    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Assessment_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id']}))
...
class AdminPMSAssessmentNew(CreateView):
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Assessment', kwargs={"pms_id": self.kwargs["pms_id"]}))

    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Assessment', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSAssessmentOneResponseSTlOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Assessment_One_STl_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Assessment_One_STl_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
                                                    'd_id': self.kwargs['d_id'], }))
...
class AdminPMSAssessmentOneResponseTlSOne(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(reverse('tydia_url_Admin_PMS_Assessment_One_TlS_One',
                                   kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
                                           'd_id': self.kwargs['d_id'], }))
    ...
    def form_valid(self, form):
        ...
        return HttpResponseRedirect(reverse('tydia_url_Admin_PMS_Assessment_One_TlS_One',
                                            kwargs={"pms_id": self.kwargs["pms_id"], 'as_id': self.kwargs['as_id'],
                                                    'd_id': self.kwargs['d_id'], }))
...
class AdminPMSMatrixScore(UpdateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Admin_PMS_Matrix_Score', kwargs={"pms_id": self.kwargs["pms_id"], 'm_id': self.kwargs['m_id']}))
...
class AdminPMSMatrixScoreNew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Admin_PMS_Matrix', kwargs={"pms_id": self.kwargs["pms_id"]}))
...
class AdminPMSMatrixKPINew(CreateView):
    ...
    def get_success_url(self):
        return '{}'.format(
            reverse('tydia_url_Admin_PMS_Matrix_KPI', kwargs={"pms_id": self.kwargs["pms_id"]}))
